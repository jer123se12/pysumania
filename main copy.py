...
def rungame(w, h, s, c, o, scr, n, n2):
    # w: screen width
    # h: screen height
    # s: seperation
    # c: colors for lanes
    ...
    lanes = [
        ...
        int((screen_width / 2) + 3 * sirclick),
    ]
    size = (int(lanes[3] - lanes[0] + sirclick + sirclick), int(screen_height))
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_a:
                    ...
                    if song[0][0] - 22 < timepassed and timepassed < song[0][0] + 22:
                        ...
                        combo += 1
                        a= 3
                    elif song[0][0] - 135 < timepassed and timepassed < song[0][0] + 135:
                        offset2.append(temp)
                        diff = temp
                        combo += 1
                        a= 2
                    elif song[0][0] - 180 < timepassed and timepassed < song[0][0] + 180:
                        diff = temp
                        combo = 0
                        a= 1
                    elif song[0][0] - 200 < timepassed and timepassed < song[0][0] + 200:
                        diff = temp
                        combo = 0
                        # combo break here?
                        a= 0
                ...
                if event.key == pygame.K_s:
                    ...
                    if song[1][0] - 22 < timepassed and timepassed < song[1][0] + 22:
                        ...
                        combo += 1
                        a= 3
                    elif song[1][0] - 135 < timepassed and timepassed < song[1][0] + 135:
                        offset2.append(temp)
                        diff = temp
                        combo += 1
                        a= 2
                    elif song[1][0] - 180 < timepassed and timepassed < song[1][0] + 180:
                        diff = temp
                        combo = 0
                        a= 1
                    elif song[1][0] - 200 < timepassed and timepassed < song[1][0] + 200:
                        diff = temp
                        combo = 0
                        # combo break here?
                        a= 0
                ...
                if event.key == pygame.K_k:
                    ...
                    if song[2][0] - 22 < timepassed and timepassed < song[2][0] + 22:
                        ...
                        combo += 1
                        a= 3
                    elif song[2][0] - 135 < timepassed and timepassed < song[2][0] + 135:
                        offset2.append(temp)
                        diff = temp
                        combo += 1
                        a= 2
                    elif song[2][0] - 180 < timepassed and timepassed < song[2][0] + 180:
                        diff = temp
                        combo = 0
                        a= 1
                    elif song[2][0] - 200 < timepassed and timepassed < song[2][0] + 200:
                        diff = temp
                        combo = 0
                        # combo break here?
                        a= 0
                ...
                if event.key == pygame.K_l:
                    ...
                    if song[3][0] - 22 < timepassed and timepassed < song[3][0] + 22:
                        ...
                        combo += 1
                        a= 3
                    elif song[3][0] - 135 < timepassed and timepassed < song[3][0] + 135:
                        offset2.append(temp)
                        diff = temp
                        combo += 1
                        a= 2
                    elif song[3][0] - 180 < timepassed and timepassed < song[3][0] + 180:
                        diff = temp
                        combo = 0
                        a= 1
                    elif song[3][0] - 200 < timepassed and timepassed < song[3][0] + 200:
                        diff = temp
                        combo = 0
                        # combo break here?
                        a= 0
