...
def rescreen(screen_width,screen_height,timeings,score,percent):
    ...
    colors=[(255,0,0),(100,100,100),(100,100,150),(100,150,100),(0,255.0),(255,255,0),(255,255,255)]
    ...
    while running:
        for event in pygame.event.get():
            ...
            if event.type==pygame.KEYDOWN:
                if event.type==pygame.K_RETURN or event.type==pygame.K_ESCAPE:
                    running=False
        screen.fill((0,0,0))
        clock.tick(60)
        ...
        if start<screen_height/2:
            ...
            screen.blit(te,tere)
            pygame.draw.rect(screen,(100,100,100),pygame.Rect(10,2*(screen_height/3),screen_width-20,(screen_height/3)-10))
            pygame.draw.line(screen,(255,255,255),(10,(2.5*(screen_height/3))-10),(screen_width-10,(2.5*(screen_height/3))-10))
            for a in [-22,22,45,-45,-90,90,-135,135,180,-180]:
                y=((2.5*(screen_height/3))-10)+((((screen_height/3)-10)/400)*a)
                pygame.draw.line(screen, (255, 255, 255), (10, y),
                                 (screen_width - 10, y),width=2)
            i2=0
            for a in timings[:i]:
                ...
                if scored[i2]<2:
                    ...
                    pygame.draw.rect(screen, (255, 0, 0),
                                     pygame.Rect(x, 2 * (screen_height / 3), 2,
                                                 (screen_height / 3) - 10))
                else:
